...
<button id="sidebarToggleTop" class="btn btn-link rounded-circle mr-3 ml-0">
    <i class="fa fa-bars"></i>
</button>
    <img src="../img/logo/iiitn.png" style="width:70px;height:70px">
            <div class="sidebar-brand-text mx-3" style="white-space: nowrap; color:white; font-size: 21px;">
                भारतीय सूचना प्रौद्योगिकी संस्थान, नागपुर<br> 
