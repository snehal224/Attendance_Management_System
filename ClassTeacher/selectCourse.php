      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Class - (<?php echo $rrw['courseName'];?>)</h1>
            <ol class="breadcrumb">
          ...
          <?php 
$query1=mysqli_query($conn,"SELECT * from tblstudents where courseId = '$_SESSION[courseId]' ");                       
...
?>
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT * from tblattendance where courseId = '$_SESSION[courseId]' ");                       
