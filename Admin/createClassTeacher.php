...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"INSERT into tblclassteacher(firstName,lastName,emailAddress,password,phoneNo,courseId,dateCreated) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$courseId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    emailAddress='$emailAddress', password='$password',phoneNo='$phoneNo', classId='$courseId'
    where Id='$Id'");
            if ($query) {
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
                   ...
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                          ...
                          $num = $result->num_rows;
                          if ($num > 0) {
                              echo '<select name="courseId" class="form-control mb-3" required>';
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Course Teachers</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <?php
                      $query = "SELECT tblclassteacher.Id,tblcourse.courseName,tblclassteacher.firstName,
                                            tblclassteacher.lastName,tblclassteacher.emailAddress,tblclassteacher.phoneNo,tblclassteacher.dateCreated
                                            FROM tblclassteacher
                                            INNER JOIN tblcourse ON tblcourse.courseId = tblclassteacher.courseId"; // Closing parenthesis was missing here
